...
from reworked_diffusion_policy.config import get_config as get_default_config
from reworked_diffusion_policy.platonic_config import get_config as get_platonic_config
from reworked_diffusion_policy.models.diffusion_policy import (
    DiffusionPolicy,
    DiffusionPolicyConfig,
)
from reworked_diffusion_policy.models.platonic_policy import (
    PlatonicDiffusionPolicy,
    PlatonicDiffusionPolicyConfig,
)
from reworked_diffusion_policy.models.platonic_transformer.groups import PLATONIC_GROUPS
...
def _infer_model_type(cfg: ConfigDict, payload: dict) -> str:
    ...
    if model_cfg is not None and hasattr(model_cfg, "transformer"):
        return "platonic"
