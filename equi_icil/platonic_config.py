...
def get_config() -> ConfigDict:
    ...
    cfg.model.transformer.input_scalar_dim = 384  # Map the input scalars to this dim.
    cfg.model.transformer.input_vector_dim = (
        1  # action xyz are treated as vector inputs, rest as scalar inputs.
    )
    ...
    cfg.model.transformer.drop_path_rate = 0.0
    ...
    cfg.model.transformer.use_key = True
    ...
    cfg.model.policy = "platonic_diffusion"

    cfg.model.in_context = ConfigDict()
    cfg.model.in_context.scalar_embedding_hidden_dim = 128
