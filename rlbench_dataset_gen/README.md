...
To install the Viser tool for visualizing pointcloud trajectories:
...
To generate example demos **with point cloud data** use e.g.:

```bash
python -m rlbench.dataset_generator_pc --save_path ./output_data --tasks reach_target --episodes_per_task 5 --image_size 256 256 --processes 1
```

To now visualize a generated demo use:

```bash
python tests/demos/visualize_merged_point_cloud.py ./output_data/reach_target/variation0/episodes/episode0
```
